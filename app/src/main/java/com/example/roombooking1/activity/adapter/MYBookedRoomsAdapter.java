...
import com.example.roombooking1.activity.model.MyBookedRoomsPojo;
...
public class MYBookedRoomsAdapter extends BaseAdapter {
    ...
    public View getView(final int pos, View view, ViewGroup viewGroup) {
        ...
        TextView tv_othr = (TextView) obj2.findViewById(R.id.tv_hardwere);
        tv_hardwere.setText("Other Equipment  :" + ar.get(pos).getOther());
        ...
        TextView tv_reason = (TextView) obj2.findViewById(R.id.tv_reason);
        tv_reason.setText("Reason For Booking  :" + ar.get(pos).getReason());

        TextView tv_Duration = (TextView) obj2.findViewById(R.id.tv_duration);
        tv_Duration.setText("Duration  :" + ar.get(pos).getDuration());
